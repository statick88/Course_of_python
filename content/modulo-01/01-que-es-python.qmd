...
Eso son los lenguajes de programación especializados. C es como un
destornillador profesional — hace UNA cosa extremadamente bien. Java es como una
llave inglesa ajustable — versátil pero pesada.

**Python es como un multiherramienta Swiss Army**. No es el mejor destornillador
del mundo, pero puedes hacer el 90% del trabajo con una sola herramienta. Y eso
lo hace increíblemente valioso.
...
Python tiene una filosofía escrita. Se llama **"El **Zen de Python****" y puedes
leerla directamente en tu computadora:

```python
import this # <1>
```

1. El módulo `**this**` contiene el Zen de Python. Al importarlo, se imprime en
...
Debe haber una forma obvia de hacer las cosas

Esto significa que en Python, **escribimos código para que los humanos lo
lean**, no las máquinas.
...
1. En Python, una sola línea de código es suficiente para imprimir texto en
pantalla.
