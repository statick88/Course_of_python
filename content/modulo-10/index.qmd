...
Estos son los proyectos que construirás. **Elige UNO** según tu nivel de
ambición:
...
## 🎓 Proyecto Especial: Sistema de Gestión ABACOM

Este es el **proyecto oficial del curso** — una aplicación completa de gestión educativa desarrollada con metodologías profesionales.

| Recurso | Descripción |
|---------|-------------|
| [Sistema ABACOM](proyecto-sistema-gestion-abacom.qmd) | Documentación completa del proyecto |
| [Repositorio](https://github.com/statick88/abacom-gestion) | Código fuente en GitHub |
...
Aprender a programar es como aprender a cocinar. Puedes memorizar recetas
individuales, pero **hasta que no cocinas una cena completa para invitados, no
sabes si realmente dominas la cocina**.

Este módulo es esa cena. No es una receta más — es el momento donde **tú decides
el menú, tú eliges los ingredientes, y tú cocinas**.
:::
