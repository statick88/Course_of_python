...
Eres el desarrollador de un equipo que está construyendo una aplicación. Tu
primera tarea es crear un módulo reutilizable con funciones de conversión que
todo el equipo pueda usar.

## Tu misión

Crea un módulo llamado `conversiones.py` que contenga:

1. Una función `celsius_a_fahrenheit(celsius)` que convierta grados Celsius a
Fahrenheit
2. Una función `fahrenheit_a_celsius(fahrenheit)` que convierta grados
