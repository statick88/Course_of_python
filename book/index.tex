...
\begin{document}
  ...
  \newgeometry{top=35mm,bottom=30mm,right=30mm,left=30mm}
  ...
  %\vspace{5cm}
  % background image
  \ThisULCornerWallPaper{1}{templates/latex/cover\_page.png}

  % Title and subtitle
  {\huge\bfseries\nohyphens{Curso de Python 2023}}\\[1\baselineskip] 
  ...
  %
  {\Large{Lcdo. Diego Saavedra Mgtr.}}%
  %
  %
  ...
  \restoregeometry
  \ULCornerWallPaper{1}{templates/latex/page_background.png}
