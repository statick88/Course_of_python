...
- Definimos la clase "Rectangulo" con un constructor __init__ que toma dos argumentos: "ancho" y "alto". Estos argumentos se utilizan para inicializar los atributos de instancia "ancho" y "alto".
