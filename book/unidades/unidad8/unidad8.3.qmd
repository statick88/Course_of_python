...
![](images/Modelo Template View.png){fig-align="center"}

En esta lección, profundizaremos en el patrón Modelo-Template-View (MTV) de Django y cómo se aplica al crear un **CRUD** (Crear, Leer, Actualizar, Eliminar) de tareas.

## Conceptos Clave

### Modelo (Model).

![](images/models.png){fig-align="center" width="300"}
...
![](images/templates.png){fig-align="center" width="300"}
