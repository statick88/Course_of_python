...
<summary>Ejemplo de Clase/Método/Actividad</summary>

Resumen:

Resumen del ejemplo o actividad.

Resolución:

Código o pasos para resolver el ejemplo o actividad.

Explicación:

Explicación de cómo funciona la resolución o el ejemplo.
